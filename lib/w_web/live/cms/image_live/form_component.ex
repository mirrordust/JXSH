defmodule WWeb.CMS.ImageLive.FormComponent do
  use WWeb, :live_component
  ...
  defp save_image(socket, :edit, image_params) do
    case CMS.update_image(socket.assigns.image, image_params) do
      {:ok, _image} ->
        {:noreply,
         socket
